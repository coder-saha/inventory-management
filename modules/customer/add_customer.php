  ...
  <body>
    ...
    <section class="content">
      <div class="edit-form-container">
        <h3>Add Customer</h3>
        <br />
        <form method="post" action="add_customer" enctype="multipart/form-data" novalidate>
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
              ...
              <input type="text" name="customer_mobile"
                ...
                value="<?= $_POST["customer_mobile"] ?>" required />
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
              <label for="billing_address" class="form-label<?= isset($errors["billing_address"]) ? " is-invalid" : ""; ?>">Billing Address</label>
              <textarea name="billing_address" class="form-control<?= isset($errors["billing_address"]) ? " is-invalid" : ""; ?>"
                id="billing_address" required><?= $_POST["billing_address"] ?></textarea>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
              <label for="shipping_address" class="form-label<?= isset($errors["shipping_address"]) ? " is-invalid" : ""; ?>">Shipping Address</label>
              <textarea name="shipping_address" class="form-control<?= isset($errors["shipping_address"]) ? " is-invalid" : ""; ?>"
                id="shipping_address" required><?= $_POST["shipping_address"] ?></textarea>
