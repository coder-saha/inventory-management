...
if (isset($_SESSION["user_id"]) && isset($_SESSION["username"])) {
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST" && count($returnSaleProductList) > 0) {
    header("Location: confirm_return_sale");
  }
  try {
  ...
  <body>
    ...
    <section class="content">
      <div class="sale-form-container">
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn" title="Remove"
                          onclick="removeProductFromSaleReturn('<?php echo $row['sku']; ?>')"><i
        ...
        <form method="post" action="return_sale" enctype="multipart/form-data" novalidate>
    ...
    <script>
      ...
      function addProductToSaleReturn(id) {
        $.post("../functions/sale_return",
          {
            "operation": "addProductToSaleReturn",
            "skuId": id
          },
          function (data) {
            // handle response
      ...
      function removeProductFromSaleReturn(id) {
        $.post("../functions/sale_return",
          {
            "operation": "removeProductFromSaleReturn",
            "skuId": id
          },
          function (data) {
            // handle response
