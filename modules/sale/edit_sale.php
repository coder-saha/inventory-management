...
if (isset($_SESSION["user_id"]) && isset($_SESSION["username"]) && $_SESSION["user_type"] === "admin") {
    ...
    if (!isset($_SESSION["edit_sale_invoice_no"]) || $_SESSION["edit_sale_invoice_no"] !== $edit_sale_invoice_no) {
      ...
      try {
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          $_SESSION["edit_customer_id"] = $rows[0]["customer_id"];
          $_SESSION["edit_customer_name"] = $rows[0]["customer_name"];
          $_SESSION["edit_sale_date"] = $rows[0]["sale_date"];
          if ($_SESSION["edit_customer_id"] === "1") {
            $_SESSION["edit_customer_type"] = "walkin";
            $customerType = "walkin";
          } else {
  ...
  if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    unset($_SESSION["edit_sale_invoice_no"]);
    $url = "Location: edit_sale2?saleId={$edit_sale_invoice_no}";
    //echo $url;
    header("Location: edit_sale2?saleId={$edit_sale_invoice_no}");
  }
  try {
    ...
    <section class="content">
      <div class="sale-form-container">
        ...
        <?php } else { ?>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                ...
                <input type="date" name="sale_date"
                  ...
                  value="<?= $_SESSION["edit_sale_date"] ?? "" ?>" onblur="setSaleDate()" required />
            ...
            <div class="row">
              <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                ...
                <input type="text" name="customer_name"
                  ...
                  value="<?= $_SESSION["edit_customer_name"] ?? "" ?>" />
              ...
              <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                ...
                <textarea name="billing_address"
                  ...
                  value="<?= $_SESSION["billing_address"] ?? "" ?>"></textarea>
              ...
              <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                ...
                <textarea name="shipping_address"
                  ...
                  value="<?= $_SESSION["shipping_address"] ?? "" ?>"></textarea>
          ...
          <form method="post" action="edit_sale" enctype="multipart/form-data" novalidate>

            <div class="row">
              <div class="mb-3">
                <button type="submit" id="proceed" class="btn btn-success btn-update">Proceed</button>
